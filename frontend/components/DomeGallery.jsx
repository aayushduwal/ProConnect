...
export default function DomeGallery({
  ...
  const cssStyles = `
    ...
    .item__image:hover {
      ...
      -webkit-transform: translateZ(20px) scale(1.15);
      z-index: 10;
      box-shadow: 
    ...
    .sphere-item:nth-child(3n) .item__image {
      animation: subtle-float 6s ease-in-out infinite;
    }
    .sphere-item:nth-child(3n+1) .item__image {
      animation: subtle-float 7s ease-in-out infinite;
      animation-delay: -2s;
    }
    .sphere-item:nth-child(3n+2) .item__image {
